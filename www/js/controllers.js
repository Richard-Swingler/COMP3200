  ...
  function update(){
    if(editor.input.activePointer.isDown && create_button.on){
      if(editor.input.activePointer.justPressed(50)){
        ...
        // recX = Math.round(editor.input.activePointer.x - orX /50)*50;
        // recY = Math.round(editor.input.activePointer.y - orY /50)*50;

        console.log(isNegative(recX));
        console.log(isNegative(recY));
        //console.log(recY);
        console.log('------');
      ...
      console.log('we may have something here');
      shadow = null;
...
//[TODO] -> $stateparams = getting item by id/usefull for getting furniture/info on records
